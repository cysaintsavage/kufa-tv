import { CODE_CLOUD_BD, MRGIFY_TV, PRIATES_TV, AKASH_TV, DEKHO_PRIME, ADULT_IPTV } from './multipleChannelData'
...
const multiSources = [CODE_CLOUD_BD, MRGIFY_TV, PRIATES_TV, AKASH_TV, DEKHO_PRIME, ADULT_IPTV]
